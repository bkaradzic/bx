...
#	endif // defined(__NetBSD__)
		...
		SetThreadDescriptionProc SetThreadDescription = BX_CAST_FUNCTION(SetThreadDescriptionProc, GetProcAddress(GetModuleHandleA("Kernel32.dll"), "SetThreadDescription"));
